...
/** Code indexing and search per project/client (search_project_code). */
...
/** Heuristic: does the file's header say it is generated? (reads ~2KB). */
...
/** Walks a repo and returns the indexable code files. */
...
/** Slices a file into overlapping line windows; the path is prepended. */
...
/** Hybrid search (vector + FTS) over a project's indexed code. */
...
/** Indexes (or reindexes) a local repo into a project. Returns the number of chunks. */
